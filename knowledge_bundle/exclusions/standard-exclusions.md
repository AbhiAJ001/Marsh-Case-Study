...
description: Common exclusions across all health insurance policies — cosmetic surgery,
  self-inflicted injuries, substance abuse, etc.
tags:
- exclusion
- standard
- all-policies
sources:
- id: hdfc-product-brochure-p12
  resource: Policy Documents/HDFC Product Brochure.pdf#page=12
  title: Page 12
- id: hdfc-product-brochure-p13
  resource: Policy Documents/HDFC Product Brochure.pdf#page=13
  title: Page 13
generated:
