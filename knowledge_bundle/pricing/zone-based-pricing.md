...
description: Care Health's 7-zone regional pricing system that adjusts premiums based
  on city of residence for fairness.
tags:
- pricing
- zones
- regional
- care-health
sources:
- id: care-health-product-brochure-p2
  resource: Policy Documents/Care Health Product Brochure.pdf#page=2
  title: Page 2
generated:
