...
description: Comparison of available Sum Insured ranges across all four policies —
  from ₹5 Lakhs to ₹6 Crores.
tags:
- pricing
- sum-insured
- comparison
- all-policies
sources:
- id: hdfc-product-brochure-p2
  resource: Policy Documents/HDFC Product Brochure.pdf#page=2
  title: Page 2
generated:
