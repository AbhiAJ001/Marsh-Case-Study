...
description: Covers medical expenses for hospitalisation exceeding 24 hours including
  room, nursing, ICU, and treatment costs.
tags:
- coverage
- hospitalisation
- inpatient
- all-policies
sources:
- id: hdfc-product-brochure-p4
  resource: Policy Documents/HDFC Product Brochure.pdf#page=4
  title: Page 4
